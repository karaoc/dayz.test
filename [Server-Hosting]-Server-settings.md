...
Bool. If set to 1, create a marker on the map on the airdrop drop location.

### "Server3DMarkerOnDropLocation"
Bool. If set to 1, show this marker in 3D.

### "ShowAirdropTypeOnMarker"
Bool. If set to 1, show what type of airdrop it is (military, medical for example).
